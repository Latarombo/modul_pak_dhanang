...
<style>
  ...
  .form-card { background:#fff; border:1px solid #ece8e0; border-radius:10px; max-width:720px; }
  .form-card-header { padding:1.6rem 2rem 1.2rem; border-bottom:1px solid #f0ece4; }
  .form-card-header h2 { font-family:'Playfair Display',serif; font-size:1.25rem; color:var(--forest); margin:0 0 .2rem; }
  .form-card-header p  { font-size:.82rem; color:#aaa; margin:0; }
  .form-card-body { padding:2rem; }

  .field-group { margin-bottom:1.4rem; }
  .field-label { display:block; font-size:.72rem; font-weight:500; letter-spacing:.1em; text-transform:uppercase; color:#666; margin-bottom:.45rem; }
  .required-star { color:var(--orange); margin-left:2px; }
  .field-hint { font-size:.72rem; color:#bbb; margin-top:.3rem; }

  .form-control, .form-select { border:1.5px solid #ddd; border-radius:6px; padding:.65rem 1rem; font-family:'DM Sans',sans-serif; font-size:.9rem; background:#fff; transition:border-color .2s; width:100%; }
  .form-control:focus, .form-select:focus { border-color:var(--forest); box-shadow:0 0 0 3px rgba(46,76,24,.1); outline:none; }
  ...
  .check-label, .radio-label { display:flex; align-items:center; gap:.4rem; background:#f7f4ef; border:1.5px solid transparent; border-radius:6px; padding:.45rem .9rem; font-size:.85rem; color:#555; cursor:pointer; transition:border-color .15s,background .15s; user-select:none; }
  ...
  .check-label:has(input:checked), .radio-label:has(input:checked) { border-color:var(--forest); background:rgba(46,76,24,.07); color:var(--forest); font-weight:500; }

  .select-multi { border:1.5px solid #ddd; border-radius:6px; font-family:'DM Sans',sans-serif; font-size:.88rem; padding:.4rem; width:100%; background:#fff; }
  .select-multi:focus { border-color:var(--forest); box-shadow:0 0 0 3px rgba(46,76,24,.1); outline:none; }
  ...
  .section-label-group { font-size:.68rem; font-weight:600; letter-spacing:.14em; text-transform:uppercase; color:#aaa; margin-bottom:1.2rem; }

  .btn-submit { padding:.7rem 1.8rem; background:var(--forest); color:#fff; border:none; border-radius:6px; font-family:'DM Sans',sans-serif; font-size:.9rem; font-weight:500; cursor:pointer; transition:background .2s; }
  .btn-submit:hover { background:#3d6420; }
  .btn-reset { padding:.7rem 1.4rem; background:transparent; color:#888; border:1.5px solid #ddd; border-radius:6px; font-family:'DM Sans',sans-serif; font-size:.9rem; cursor:pointer; transition:border-color .2s,color .2s; }
  .btn-reset:hover { border-color:#bbb; color:#555; }
  .btn-back { display:inline-block; margin-bottom:1.2rem; font-size:.82rem; color:#888; text-decoration:none; }
